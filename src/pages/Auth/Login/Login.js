...
function Login() {
  ...
  return (
    <div className="h-100-vh w-full flex items-center justify-center">
      <div className="w-47-0 px-4-0 bg-white h-40-0 rounded-1-2 flex flex-col justify-center w-full">
